...
- §16-08 — Coax inspection (the cable side)
- §12-07 — Water ingress (the symptom side, especially in the antenna)
- §16-04 — Coax replacement (when a cable has been wet for too long)
- §13-05 — Grounding (entry-point lightning protection)
