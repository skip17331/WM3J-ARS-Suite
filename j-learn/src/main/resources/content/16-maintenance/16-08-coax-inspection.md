...
If you've been keeping baseline data (per §16-00), compare today's SWR sweep to your historical record. Look at:
...
- §16-04 — Coax replacement (the next-level decision)
- §16-09 — Cable entry & water intrusion
- §12-01 — Coax issues (troubleshooting symptoms)
- §12-07 — Water ingress (what wet coax looks like)
- §18 — Coax & connectors reference
- §10 — Feedline & SWR (the math behind cable loss)
