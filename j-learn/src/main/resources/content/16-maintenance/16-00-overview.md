...
- **Detailed lightning protection design** — surge arrestors, single-point grounding, and bonding are in §16-07 and §13-05; designing a complete NFPA 780 system at scale needs an engineer.
...
- §12 — High-SWR troubleshooting (the symptom side of antenna problems)
- §13 — Station troubleshooting
- §13-05 — Grounding (the troubleshooting view of the ground system)
