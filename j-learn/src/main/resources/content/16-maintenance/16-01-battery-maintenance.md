...
- §16-03 — Inspections (battery terminal corrosion shows up here)
- §15 — Noise sources (battery chargers can be RFI sources — see SMPS)
- §13-06 — Power supply troubleshooting
