...
- §06-01 — FCC rules (the regulatory framework)
- §06-03 — Controlled vs uncontrolled (which limit applies where)
- §06-04 — Duty cycle (the time-averaging factor)
- §06-05 — ERP (the input to power-density calculations)
- §06-06 — Safe antenna placement (using these limits in installation design)
