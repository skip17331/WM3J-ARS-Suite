...
1. **Know your ERP** on each band. (See §06-05.)
...
3. **Compute or look up the MPE distance** for that ERP and that frequency. (Tables in §06-02; the ARRL has a free online evaluator. The J-Hub RF Exposure Calculator at §10 does this interactively.)
...
The "magnetic loop on your desk" case is one of the genuinely problematic amateur configurations, even at low power. See §06-06.
...
- **§10 (RF Exposure Calculator)** — interactive calculator. Enter band, ERP, antenna distance; get controlled/uncontrolled compliance status.
- **§09 (Power Budget / ERP)** — work out your ERP given TX power, feedline loss, and antenna gain.
- **§06 (this chapter)** — the conceptual background for both calculators.

## See also

- §10 — RF Exposure Calculator (the practical tool)
- §09 — ERP / Power Budget
- §04-13 — Ground-plane effects (matters for near-field calculation)
- §04-15 — Patterns (gain at the relevant elevation matters for exposure direction)
