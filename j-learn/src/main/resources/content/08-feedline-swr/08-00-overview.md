...
This chapter covers the relationship between SWR (Standing Wave Ratio), feedline loss, and what actually arrives at your antenna. The math here is the foundation of antenna-system design and is referenced by §04-10 (feedline effects on antenna behavior), §09 (power budget), §10 (high-SWR troubleshooting), and §18 (coax & connectors reference).
...
- **Baluns and chokes** — see §04-12 (full discussion) and §18-05 (reference).
...
- **§07 (Antenna calculator)** uses these formulas to compute physical lengths.
