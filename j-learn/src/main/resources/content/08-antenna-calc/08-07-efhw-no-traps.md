...
- §05-04 — EFHW (theory chapter — related single-band variant)
- §08-00 — Antenna Workshop overview
- §08-08 — EFHW (Trapped) — the multi-band variant with traps
- §08-15 — NanoVNA Trim Workflow
- §21-04 — Impedance (where the high end-Z comes from)
- §22 — Coax & Connectors (for the coax run)
