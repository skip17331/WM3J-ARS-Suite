...
Per §18 (Shack Inventory), store sweeps in `/shack-data/sweeps/A-001-2026-04.csv` (or wherever you organize them).
...
- §05-09 — Smith Charts (for matching-network analysis)
- §08-00 — Antenna Workshop overview
- §13 — High-SWR Troubleshooting (when the sweep is unexpected)
- §18-02 — Antennas (where to store baseline sweeps in inventory)
- §21-04 — Impedance (the math behind R + jX readings)
- §21-07 — SWR (the math behind SWR readings)
- §21-13 — Smith Chart Basics (interpreting the chart)
