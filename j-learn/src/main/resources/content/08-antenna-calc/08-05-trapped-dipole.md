...
The actual trap component values come from **§08-13 Trap Design** — the calculator's outputs feed directly into that.
...
1. **Build the traps first** using the §08-13 Trap Design calculator. Verify each trap's resonance with a NanoVNA or dip meter on the bench before installing.
...
- §05-08 — Traps (theory chapter for trap antennas)
- §08-00 — Antenna Workshop overview
- §08-13 — Trap Design (component values, coil winding)
- §08-04 — Fan Dipole (alternative approach to multi-band)
- §08-15 — NanoVNA Trim Workflow
- §21-05 — Resonant Frequency
- §21-11 — Q Factor (relevant to trap loss)
