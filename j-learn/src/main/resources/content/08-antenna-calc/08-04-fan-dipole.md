...
- §05 — Antennas (theory chapter on parallel-element interactions)
- §08-00 — Antenna Workshop overview
- §08-02 — Flat Dipole (single-band baseline)
- §08-05 — Trapped Dipole (alternative for multi-band — uses traps instead of fan)
