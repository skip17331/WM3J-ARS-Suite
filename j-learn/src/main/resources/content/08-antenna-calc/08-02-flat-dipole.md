...
The "468" embeds the 5% end-effect correction for thin wire well above ground (see §21-06). For thick aluminum tubing or wire near other conductors, the constant shifts to 460–475.
...
- §05 — Antennas (theory chapter for dipole physics)
- §08-00 — Antenna Workshop overview (what a calculator is)
- §08-15 — NanoVNA Trim Workflow (the systematic build-and-trim procedure)
- §21-06 — Wavelength (where 468 / 234 come from)
- §21-04 — Impedance (feed-Z math)
