...
- **Morse code itself** — see §03 for learning to send and copy CW.
...
- **Digital-mode "shorthand"** — JS8Call's compressed messages, FT8's predefined fields, etc., are mode-specific (see §19).

## See also

- §03 — Morse (learning to send/copy)
- §19 — Digital modes (where some of this vocabulary appears in modern usage)
- §02 — Repeaters & bandplans (calling conventions on FM)
- §20 — EmComm (procedure-heavy use of phonetics)
