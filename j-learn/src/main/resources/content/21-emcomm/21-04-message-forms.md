...
For the network that carries these messages, see §21-01 (NTS) and §21-02 (ICS). For the procedures used while transmitting them, see §21-05.
...
- §21-01 — NTS (the network for radiogram delivery)
- §21-02 — ICS basics (the framework for ICS-213)
- §21-05 — Operating procedures
- §19 — Q-codes & prosigns (vocabulary)
- §03 — Digital modes (NBEMS, Fldigi)
