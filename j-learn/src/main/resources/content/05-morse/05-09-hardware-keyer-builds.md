...
- §05-00 — Morse overview (launches the trainer)
- §05-06 — Send practice (the trainer mode that uses these keyers)
- §05-07 — Speed tracking (where the trainer's diagnostics live)
