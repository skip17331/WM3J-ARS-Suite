...
1. **RF safety compliance** (§07): MPE limits are computed against EIRP; you need this number to check your station's compliance with FCC §97.13.
...
- **Antenna pattern shape and how gain is measured** — see §05-15.
- **Specific feedline loss values per cable / frequency** — see §22-02.
- **Detailed Smith chart impedance work** — see §05-09.
- **Propagation losses on the path to a distant station** — see §01.
- **RF safety calculation specifics** — see §07-05.
...
- **§08 (Antenna Calculator)**: complementary — computes physical lengths.

## See also

- §07-05 — ERP / EIRP for RF safety
- §11-05 — Portable budget (worked example)
- §22 — Coax & connectors (the feedline-loss source)
- §05-15 — Radiation patterns (where antenna gain comes from)
