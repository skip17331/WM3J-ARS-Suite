...
This is the single number that summarizes "how loud is your station, in the direction you care about." It's also the number used for FCC RF exposure compliance (§08-05), DX path-loss calculations, and antenna-system comparisons.
...
3. Use the §08-02 MPE limits for the operating frequency.
