...
The most universal fix. A **1:1 current balun** at the antenna feedpoint, plus optionally a second one at the rig end of the coax, breaks the common-mode current path. Discussed in §12-05.
