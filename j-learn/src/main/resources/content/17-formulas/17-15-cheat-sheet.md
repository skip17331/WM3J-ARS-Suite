...
|----------|---------|-------|-----|
| Ohm's Law | V = I × R | V, A, Ω | §17-01 |
| Power (3 forms) | P = V·I = I²R = V²/R | W | §17-02 |
| Inductive reactance | X_L = 2πfL | Ω (f in Hz, L in H) | §17-03 |
| Capacitive reactance | X_C = 1 / (2πfC) | Ω (f in Hz, C in F) | §17-03 |
| Impedance magnitude | \|Z\| = √(R² + X²) | Ω | §17-04 |
| Impedance phase | φ = arctan(X / R) | degrees | §17-04 |
| Resonant frequency | f = 1 / (2π · √(L·C)) | Hz | §17-05 |
| Quick LC resonance | f(MHz) = 159.15 / √(L(µH)·C(pF)) | MHz | §17-05 |
| Free-space wavelength | λ(m) = 300 / f(MHz) | m | §17-06 |
| Half-wave dipole | length(ft) = 468 / f(MHz) | ft (thin wire, 5% end-effect) | §17-06 |
| Quarter-wave vertical | length(ft) = 234 / f(MHz) | ft | §17-06 |
| Reflection coefficient | Γ = (Z_L − Z₀) / (Z_L + Z₀) | dimensionless complex | §17-07 |
| SWR from Γ | SWR = (1 + \|Γ\|) / (1 − \|Γ\|) | dimensionless | §17-07 |
| SWR from power | \|Γ\| = √(P_r / P_f) → SWR formula above | — | §17-07 |
| ERP / EIRP | ERP = P_TX × G × L_feedline | W | §17-08 |
| dB ↔ ratio (power) | dB = 10·log₁₀(P₂/P₁) | dB | §17-10 |
| dB ↔ ratio (voltage) | dB = 20·log₁₀(V₂/V₁) | dB | §17-10 |
| dBm ↔ W | dBm = 10·log₁₀(W × 1000) | dBm | §17-10 |
| Q factor | Q = X_L / R = f / Δf₃dB | dimensionless | §17-11 |
| Bandwidth | BW = f / Q | Hz | §17-12 |
| Power density (free space) | S = EIRP / (4π · d²) | W/m² | §17-14 |
| Power density (worst case) | S = EIRP / (π · d²) | W/m² (4× ground reflect) | §17-14 |
...
| Maidenhead grid 4-char → lat/lon | (the §08-04 satellite calculator does this) |
...
- §17-00 — Formulas overview (the chapter map)
- §17-01 through §17-14 — every formula card has a calculator in the Workshop tab
- §18-02 — Coax loss tables (more cable types, more frequencies)
- §20-00 — Band Plans (where these antenna lengths apply)
