...
The SWR penalty depends on both matched loss and SWR; see §10-03 (mismatch loss) for the closed-form.
...
- §18 — Coax & Connectors (full chapter on cable selection)
- §18-02 — Loss tables (more cable types)
- §10-03 — Mismatch loss (the SWR penalty)
- §11-02 — Feedline loss in the budget chain
- §17-10 — Decibels (the dB ↔ power-factor conversion)
