...
The regulatory side (FCC §1.1310 limits, controlled vs. uncontrolled environments, evaluation requirements) lives in **§08 RF Safety**. This section is the math.
...
If S_worst ≤ S_MPE, you're compliant. If not, you must either reduce power, increase distance, reduce duty cycle, or change antenna placement (§08).
...
- §08 — RF Safety (the regulatory side; the *why*)
- §08-02 — MPE Limits (the table this section uses)
- §08-04 — Duty Cycle (how to estimate D for your operating style)
- §08-06 — Safe Antenna Placement (how to fix a failing scenario)
