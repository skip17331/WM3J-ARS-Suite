...
- **Touching coax shield during TX** doesn't usually cause RF burns — common-mode currents are usually not high enough on the shield for significant tissue damage. But it does indicate a balun problem (see §05-12).
- **The "tingling sensation" some operators feel** when touching radio gear during TX is RF "shock" — capacitive coupling of station ground potential through your body. Annoying, not usually injurious, but indicates poor station grounding (see §14-05).
...
- §07-01 — FCC rules (MPE rules; not directly burn-related but related context)
- §07-06 — Safe antenna placement (geometry to prevent burn risk)
- §05-12 — Baluns and chokes (common-mode current → tingling/burn potential)
- §05-05 — Magnetic loops (kilovolt capacitor gaps)
- §14-05 — Grounding (poor grounding → tingling sensation; precursor to burns)
- §15 — RFI (related to common-mode currents)
