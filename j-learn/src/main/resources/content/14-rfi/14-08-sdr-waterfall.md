...
- §14-07 — AM radio sniffer (the directional companion to the SDR's spectral view)
- §14-03 — sound-based identification (links to waterfall patterns above)
- §15 — power-line noise (waterfall patterns are diagnostic)
