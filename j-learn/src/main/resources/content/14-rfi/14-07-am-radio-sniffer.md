...
- **Pure RF source** that's frequency-specific (no broad spectrum). E.g., a single cleaning oscillator. Use a SDR with a waterfall (§14-08) to see exactly which frequencies are affected.
...
- §14-05 — isolation workflow (where the AM radio fits into the larger flow)
- §14-08 — SDR waterfall for visual diagnosis
- §15 — power-line noise (different hunting techniques apply)
