...
- Common-mode current on coax shield (chapter §12-06) is conducted RFI.
...
§14-03 has audio examples and detailed identification methods.
...
- §14-02 — household RFI sources you might be making
- §14-03 — sound-based identification
- §14-05 — isolation workflow
