...
- What does it sound like? (See §14-03.)
...
- Toward a power line — utility issue (§15-08 onwards).
...
A small loop, even on a portable AM radio, gives surprisingly good directional information. §14-07 covers AM-radio sniffing in detail.
...
A power-line problem is the utility's problem, but they only act on it if you formally report and follow up. See §15-15 for the documentation procedure.
...
- §14-03 — sound-based identification (do this first)
- §14-06 — step-by-step elimination (the practical detail)
- §14-07 — AM radio sniffer
- §15-15 — utility documentation for power-line cases
