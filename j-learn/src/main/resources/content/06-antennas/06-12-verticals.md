...
- High-noise environment. Verticals pick up vertically-polarized man-made noise (power lines, switching supplies) more readily than horizontals do. See §15.
...
- §06-32 — VHF/UHF antennas (the same ground-plane principles, scaled down)
