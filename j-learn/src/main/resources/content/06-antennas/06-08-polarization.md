...
- §06-07 — Radiation Patterns (pattern + polarization together)
- §06-09 — Diversity (using polarization as one diversity dimension)
- §06-33 — Satellite & EME antennas (circular polarization in practice)
- §07 — Satellites (circular polarization for sat work)
- §17-08 — ERP (when polarization-mismatch losses enter the link budget)
