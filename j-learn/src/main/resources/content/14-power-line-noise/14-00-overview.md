...
| Cause | Sound | Section |
|-------|-------|---------|
| Cracked / contaminated insulator | Sharp crackle, weather-related | §14-01 |
| Bad transformer (saturated, loose laminations) | 60 Hz buzz | §14-02 |
| Loose hardware (bolts, ground straps) | Intermittent crackle | §14-03 |
| Corona discharge | Whoosh / buzz, weather-related | §14-04 |
...
Read §14-07 first if you've already identified power-line noise and want to know what to do about it. Read the rest if you're trying to characterize what specifically you're dealing with.
...
§14-07 covers the practical procedure in detail.
...
- §14-07 — utility documentation procedure
