...
- **Bad bushings**: the insulator that carries the high-voltage line into the transformer can crack and arc, similar to §14-01.
...
Same direction-finding technique as for arcing insulators (§14-05, §14-06):
...
Same procedure as bad insulators (§14-07). Add to the documentation:
...
- §14-01 — arcing insulators (similar diagnostic approach)
- §14-04 — corona discharge
