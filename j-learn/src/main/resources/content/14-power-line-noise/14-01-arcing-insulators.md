...
Walk your neighborhood with a portable AM or shortwave radio (see §14-05 for AM, §14-06 for SDR):
...
Then file the complaint per §14-07.
...
- §14-04 — corona discharge (similar but different mechanism)
- §14-05 — AM radio identification (the practical hunt)
