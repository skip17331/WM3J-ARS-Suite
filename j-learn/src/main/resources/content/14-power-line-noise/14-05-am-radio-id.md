...
The AM radio sniffer technique from §12-07 works for power-line noise too — with some adaptations. Power-line sources are usually stronger than household sources and at a greater distance, which changes the practical procedure.
...
Save these notes. They become the basis of your utility complaint (§14-07).

## See also

- §12-07 — AM radio sniffer for household RFI (similar technique)
- §14-06 — SDR identification (alternative for harder cases)
