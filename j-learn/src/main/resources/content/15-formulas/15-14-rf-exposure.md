...
| Feedline loss | L | 0.5 dB … 10 dB | dB | §15-09 |
...
(Linear feedline-loss factor; see §15-09 for the conversion.)
...
(See §15-08 for the dBi/dBd conversion.)
...
L = 1 dB              (LMR-400, 100 ft, 14 MHz — see §15-09)
G = 6 dBd → 8.15 dBi
...
- §15-08 — ERP / EIRP (the formula card this builds on)
- §15-09 — Feedline Loss (where L comes from)
- §15-10 — Decibels (the dB ↔ linear conversions used throughout)
