...
- **Contaminated insulators**: see §17-01; the insulator itself can corona before it fully arcs.
...
2. **Listen with a portable receiver** (§17-05).
...
Same procedure as other power-line noise (§17-07). Mention that you suspect corona specifically; this helps the utility direct the right kind of inspector (transmission engineer vs. distribution lineman).

## See also

- §17-01 — arcing insulators (different mechanism)
- §17-05 — AM radio identification
- §17-07 — utility documentation
