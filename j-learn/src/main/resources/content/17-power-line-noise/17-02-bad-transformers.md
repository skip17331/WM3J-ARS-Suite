...
- **Bad bushings**: the insulator that carries the high-voltage line into the transformer can crack and arc, similar to §17-01.
...
Same direction-finding technique as for arcing insulators (§17-05, §17-06):
...
Same procedure as bad insulators (§17-07). Add to the documentation:
...
- §17-01 — arcing insulators (similar diagnostic approach)
