...
Walk your neighborhood with a portable AM or shortwave radio (see §15-13 for AM, §15-14 for SDR):
...
Then file the complaint per §15-15.
...
- §15-12 — corona discharge (similar but different mechanism)
- §15-13 — AM radio identification (the practical hunt)
