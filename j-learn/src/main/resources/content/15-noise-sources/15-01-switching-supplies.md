...
A cheap LED replacement bulb has the SMPS *inside the bulb*. Filtering it externally is hard. The fix is to replace the bulb with a quality one (Cree, Philips, GE Lighting). See §15-02.
...
- **Powerline noise from outside your property.** That's §15-08 territory; it's the utility's problem.
...
- §14-06 — step-by-step elimination
- §15-02 — LED lights (which are essentially small SMPS)
