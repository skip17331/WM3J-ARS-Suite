...
3. **RF ground** — gives the radio's transmit chain a low-impedance reference at radio frequencies. Required for many antennas to work; required to avoid RF feedback (chapter §11-04).
...
- §11-04 — RF feedback (the symptom of bad grounding)
- §10-06 — feedline routing (a related issue)
- §12-05 — RFI isolation workflow (also about ground/common-mode)
