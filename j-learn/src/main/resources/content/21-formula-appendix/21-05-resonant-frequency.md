...
> ⚙️ **Advanced —** The Q of a resonant circuit (§21-11) determines how sharp the resonance is. Q = 2π · stored energy / energy lost per cycle = X_L / R = X_C / R at resonance. A high-Q antenna trap (Q > 50) is sharply tuned and stays "open" only over a narrow band; a low-Q trap (Q ~ 10) tunes broadly but with more loss.

## See also

- §05-08 — Traps (uses this formula for multi-band antennas)
- §13-04 — High-SWR diagnosis (off-resonance is one cause)
- §21-03 — Reactance (the X_L = X_C condition that defines resonance)
- §21-11 — Q Factor (sharpness of the resonance)
- §21-12 — Bandwidth (how Q and resonance interact)
