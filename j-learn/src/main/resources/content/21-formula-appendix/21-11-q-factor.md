...
- §05-05 — Magnetic loops (where Q is a defining specification)
- §05-08 — Traps (high-Q traps stay sharp; low-Q traps tune broadly)
- §21-03 — Reactance (X_L and X_C from which Q is computed)
- §21-05 — Resonant frequency (where Q applies)
- §21-12 — Bandwidth (the f_r / Q relationship)
