...
| Q | Quality factor (§21-11) | dimensionless |
...
A receiver with a 2.5 kHz audio passband can hold about 2500 / 50 ≈ 50 simultaneous FT8 signals — which is why FT8 operates so densely. (See §25 for digital-modes bandwidth math.)
...
- §02 — Repeaters & Bandplans (channel-spacing rules)
- §05 — Antennas (antenna bandwidth specs)
- §21-05 — Resonant frequency
- §21-11 — Q Factor (relates Q to BW)
- §25 — Digital modes (where signal bandwidth is computed per protocol)
