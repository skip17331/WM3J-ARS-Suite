...
If §05-09 explains the picture and §05-11 explains the transformations, this section gives the underlying math.
...
- §05-09 — Smith Charts (the picture-side explanation)
- §05-11 — Impedance Transformation (matching networks via Smith chart)
- §21-04 — Impedance (the Z = R + jX form)
- §21-07 — SWR (the radius-from-center reading)
