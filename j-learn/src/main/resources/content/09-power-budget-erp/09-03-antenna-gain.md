...
The "antenna at 0.5 λ above good ground has gain X dBi" numbers in §04-15 already include the ground-reflection gain. Modeling software reports both free-space and over-real-ground, distinguishing the two.
...
- §04-15 — Radiation patterns (where these gain numbers come from)
- §04-13 — Ground-plane effects (how ground modifies free-space gain)
- §04-14 — Modeling concepts
