...
This section unpacks what SWR is, what it tells you, and how it relates to forward and reflected power. The companion sections cover the *consequences* of high SWR — extra loss (§10-03), reduced delivered power (§10-04), and feedline transformation (§10-06).
...
Note: this assumes a lossless feedline. With real feedline loss, the picture is more complicated — see §10-03.
