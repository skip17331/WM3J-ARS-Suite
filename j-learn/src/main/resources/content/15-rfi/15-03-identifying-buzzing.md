...
A waterfall display shows you the time and frequency pattern at once. Bursty sources are obvious; constant sources show as horizontal lines; tonal sources show as bright vertical lines. §15-08 covers this in detail.
...
A cheap portable AM radio held near suspect devices is the oldest and still one of the best direction-finding tools. Detail in §15-07.
...
- §15-02 — household sources by category
- §15-07 — AM radio sniffer for direction-finding
- §15-08 — SDR waterfall for visual diagnosis
- §16 — detailed source-by-source guides
