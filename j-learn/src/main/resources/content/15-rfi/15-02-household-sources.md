...
- §15-05 — isolation workflow (how to systematically test)
- §15-06 — step-by-step elimination (the practical procedure)
- §16 — specific noise source categories with detail
- §17 — power line noise specifically (different beast — utility issue)
