...
- Common-mode current on coax shield (chapter §13-06) is conducted RFI.
...
§15-03 has audio examples and detailed identification methods.
...
- §15-02 — household RFI sources you might be making
- §15-03 — sound-based identification
- §15-05 — isolation workflow
