...
- §25-00 — Digital modes overview (audio chain)
- §25-01 — FT8 (the parent protocol)
- §25-03 — PSK31 (faster but no FEC)
- §26 — Emergency Communications (where JS8Call shines)
- §26-04 — Major emcomm nets (some have JS8Call sub-nets)
