...
- §04-09 — Smith charts (modeling output → Smith chart visualization)
- §04-13 — Ground effects (the modeling input most people get wrong)
- §04-15 — Radiation patterns (interpreting the modeled output)
- §07 — Antenna calculator (J-Hub's simple length calculator for the cookbook cases)
