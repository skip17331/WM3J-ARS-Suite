...
- **Note the noise floor** on each band you use. A 6+ dB increase from baseline indicates a new noise source somewhere (yours or someone else's; see §13).
...
- **Check firmware notification feeds** for your major equipment. Note any new releases since last quarter. Read release notes and decide whether to update (see §14-02).
...
- **Replace any visibly degraded coax**. UV-cracked jacket means the dielectric below it is at risk. See §14-04.
...
- **Battery capacity test**. Run the annual load test (per §14-01).
...
- §14-00 — Overview (this is part of the broader maintenance discipline)
- §14-04 — Coax replacement (when an inspection turns into a replacement)
