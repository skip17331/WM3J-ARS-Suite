...
This section is the inspection guide for a station's ground system. The math behind grounding is in §11-05 (the troubleshooting view); this section is the maintenance view.
...
- §11-05 — Grounding (troubleshooting view)
- §14-08 — Coax inspection (for the connector-side of the ground system)
- §06 — RF safety (related considerations for AC and equipment grounding)
