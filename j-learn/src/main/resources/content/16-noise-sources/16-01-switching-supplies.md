...
A cheap LED replacement bulb has the SMPS *inside the bulb*. Filtering it externally is hard. The fix is to replace the bulb with a quality one (Cree, Philips, GE Lighting). See §16-02.
...
- §16-02 — LED lights (which are essentially small SMPS)
