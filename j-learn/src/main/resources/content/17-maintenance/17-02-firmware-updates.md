...
- §17-00 — Maintenance overview
- §17-03 — Scheduled inspections (firmware-check is part of the quarterly inspection)
- §11 — Station troubleshooting (when "weird stuff started after the update")
- §15 — Shack inventory (track firmware versions per device)
