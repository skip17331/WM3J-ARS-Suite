...
| Annually | Audit station inventory (per §15); review log/data backups; review uploaders' status |
...
- §15 — Shack inventory (knowing what you have makes maintenance possible)
- §10 — High-SWR troubleshooting (the symptom side of antenna problems)
- §11 — Station troubleshooting
- §19 — Coax & connectors reference (for coax-replacement decisions)
