...
- §04 — Antennas (theory chapter on parallel-element interactions)
- §07-00 — Antenna Workshop overview
- §07-02 — Flat Dipole (single-band baseline)
- §07-05 — Trapped Dipole (alternative for multi-band — uses traps instead of fan)
