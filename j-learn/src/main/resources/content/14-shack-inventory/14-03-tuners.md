...
In radio notes (§14-01): "Built-in 100W ATU; matching range to 3:1; effectively a free auto-tuner for typical antennas."
...
- **Treating in-rig ATUs as separate inventory items.** They live with the rig (§14-01).

## See also

- §14-00 — Schema overview
- §14-01 — Radios (where in-rig ATUs live)
...
- §15 — Estate / SK (tuner disposition planning)
