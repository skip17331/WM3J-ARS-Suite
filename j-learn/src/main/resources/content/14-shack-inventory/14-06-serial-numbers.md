...
- §14-01 — Radios (where serials are most-important)
- §14-05 — Accessories (some have serials, some don't)
- §14-07 — Purchase dates (paired with serials for warranty)
- §15 — Estate / SK (serial-documented items have higher resale value)
