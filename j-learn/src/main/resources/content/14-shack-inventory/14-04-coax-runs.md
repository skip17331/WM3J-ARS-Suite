...
|-------------|----------------|
| **Cable type** | RG-58, RG-213, LMR-400, etc. (cross-references §18-01) |
...
| **Connectors at each end** | PL-259, N, BNC, etc. (cross-references §18-04) |
...
Notes: Original install. No visible jacket damage. Working as expected.
       Plan replacement at 2028 (10 years) per §16-04.
```
...
For estate disposition (§15): coax runs are typically not separately resaleable. A buyer of the station wants the radios, antennas, and accessories; the coax in place is replaced or kept by the seller. Document estimated value as low-but-not-zero (salvage of connectors/copper).
...
- §14-02 — Antennas (linked to coax runs)
- §18-01 — Coax types (full reference)
- §18-04 — Connectors
- §18-02 — Loss tables
- §16-04 — Coax replacement
- §10-01 — Coax issues troubleshooting
- §15 — Estate / SK (coax not typically separately disposed)
