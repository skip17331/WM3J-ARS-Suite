...
This section applies the unified inventory schema (§14-00) to antennas, with antenna-specific fields for installation context.
...
For maintenance scheduling, **install date** is the relevant metric. A coax run installed 2020-06-01 is at year 6 of service; replace at year 10-15 depending on conditions (see §16-04).
...
For estate planning, the antenna's resale value is often less than the labor cost of removing it. Many estate sales include "antennas in place — buyer to remove." This affects the estate strategy in §15.
...
- The coax run from antenna to switch (separate row in §14-04).
- The antenna switch itself (in §14-05).
...
- §14-04 — Coax runs (linked to antennas)
- §14-05 — Accessories (rotators, switches)
- §04 — Antennas (full reference for antenna types)
- §10 — High-SWR troubleshooting (failure modes)
- §16-03 — Scheduled inspections (where antenna inspections are scheduled)
- §16-04 — Coax replacement (linked to coax-run inventory)
- §15 — Estate / SK (antenna disposition planning)
