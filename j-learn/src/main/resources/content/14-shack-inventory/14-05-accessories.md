...
This section covers everything in the inventory that isn't a radio (§14-01), antenna (§14-02), tuner (§14-03), or coax run (§14-04). The accessories category is broad: power supplies, audio gear, computers, software, batteries, antennas analyzers, soldering equipment, books, manuals, parts. Each gets a row.
...
- **Battery installs**: track install date and capacity over time (see §16-01 for the maintenance side).
...
Once accessories are inventoried, the estate-disposition planning (§15) can group them sensibly:
...
- §14-06 — Serial numbers (especially relevant for accessories with high theft value)
- §14-07 — Purchase dates (warranty tracking)
- §14-08 — Firmware versions (some accessories have firmware too)
- §16 — Maintenance (accessories need maintenance just like radios)
- §15 — Estate / SK (where accessories get disposition decisions)
