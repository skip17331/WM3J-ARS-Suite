...
This section applies the unified inventory schema (§18-00) to antennas, with antenna-specific fields for installation context.
...
For maintenance scheduling, **install date** is the relevant metric. A coax run installed 2020-06-01 is at year 6 of service; replace at year 10-15 depending on conditions (see §20-04).
...
- The coax run from antenna to switch (separate row in §18-04).
- The antenna switch itself (in §18-05).
...
- §18-04 — Coax runs (linked to antennas)
- §18-05 — Accessories (rotators, switches)
- §05 — Antennas (full reference for antenna types)
- §13 — High-SWR troubleshooting (failure modes)
- §20-03 — Scheduled inspections (where antenna inspections are scheduled)
- §20-04 — Coax replacement (linked to coax-run inventory)
- §19 — Estate / SK (antenna disposition planning)
