...
This section covers everything in the inventory that isn't a radio (§18-01), antenna (§18-02), tuner (§18-03), or coax run (§18-04). The accessories category is broad: power supplies, audio gear, computers, software, batteries, antennas analyzers, soldering equipment, books, manuals, parts. Each gets a row.
...
- **Battery installs**: track install date and capacity over time (see §20-01 for the maintenance side).
...
Once accessories are inventoried, the estate-disposition planning (§19) can group them sensibly:
...
- §18-06 — Serial numbers (especially relevant for accessories with high theft value)
- §18-07 — Purchase dates (warranty tracking)
- §18-08 — Firmware versions (some accessories have firmware too)
- §20 — Maintenance (accessories need maintenance just like radios)
- §19 — Estate / SK (where accessories get disposition decisions)
