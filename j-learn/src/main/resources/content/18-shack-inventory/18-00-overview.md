...
- **Estate planning** — a record your family can hand to a buyer or executor when you become a Silent Key, so your gear ends up in the hands of operators who'll use it instead of being sold for pennies at a yard sale (see §19).
...
- **Software licenses** — covered briefly in §18-05; full software inventory is a different beast.
- **Insurance policy details** — talk to your agent; this chapter feeds the inventory portion of the insurance discussion.
- **Estate planning legal questions** — see §19; that chapter covers what to do *with* the inventory data.
...
- A starter spreadsheet template.
- The basis for the estate module (§19) which uses this data to plan equipment disposition.

## See also

- §19 — Estate / SK (uses this inventory data)
- §20 — Maintenance (install dates and condition feed maintenance scheduling)
- §22 — Coax & connectors (reference for coax-run inventory)
- §05 — Antennas (reference for antenna inventory)
