...
Remote-base tuners eliminate the "tuner at the rig hides feedline mismatch" problem (§09-03). Higher upfront cost; better RF performance.
...
In radio notes (§18-01): "Built-in 100W ATU; matching range to 3:1; effectively a free auto-tuner for typical antennas."
...
- **Treating in-rig ATUs as separate inventory items.** They live with the rig (§18-01).

## See also

- §18-00 — Schema overview
- §18-01 — Radios (where in-rig ATUs live)
- §05-11 — Impedance transformation (what tuners do)
- §05-12 — Baluns and chokes (sometimes paired with tuners)
- §09-03 — Mismatch loss (why tuners at the rig don't always help)
- §19 — Estate / SK (tuner disposition planning)
