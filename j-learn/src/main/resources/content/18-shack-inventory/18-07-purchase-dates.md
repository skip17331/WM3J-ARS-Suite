...
1. **Check the manufacturer's production date** (sometimes derivable from serial number; see §18-06).
...
- §18-06 — Serial numbers (paired with date for warranty)
- §18-08 — Firmware versions (firmware update dates)
- §20-00 — Maintenance overview (where dates feed the schedule)
- §20-01 — Battery maintenance (calendar age matters)
- §20-04 — Coax replacement (install date sets replacement schedule)
- §19 — Estate / SK (acquisition date supports resale)
