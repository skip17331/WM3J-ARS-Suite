...
- §18-01 — Radios (where serials are most-important)
- §18-05 — Accessories (some have serials, some don't)
- §18-07 — Purchase dates (paired with serials for warranty)
- §19 — Estate / SK (serial-documented items have higher resale value)
