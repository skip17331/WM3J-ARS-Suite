...
- **An RF current probe** — for common-mode testing (covered in §14-04).
...
- §13 — high SWR (sometimes mistaken for station problems)
- §15 — RFI (often comorbid with station grounding issues)
- §16, §17 — noise sources that look like station problems
