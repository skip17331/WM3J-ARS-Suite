...
| 7:1 | 49:1 | EFHW (2500 → 50 Ω) — see §05-04 |
...
- §05-09 — Smith charts (the design tool for matching networks)
- §05-12 — Baluns and chokes (specific transformer types)
- §05-10 — Feedline effects (length affects observed Z)
- §05-04 — EFHW (the canonical unun-matched antenna)
- §21 — Formula appendix
