...
- §05-10 — Feedline effects (Smith chart shows them as rotations)
- §05-11 — Impedance transformation (Smith chart designs the network)
- §13 — High-SWR troubleshooting (Smith chart traces help diagnose)
- §21-13 — Smith chart formulas (the math, in the formula appendix)
