...
- §05-03 — Verticals (most ground-sensitive antenna)
- §05-15 — Radiation patterns (where the height-vs-angle effects show up)
- §05-14 — Modeling concepts (handling ground in NEC-style code)
