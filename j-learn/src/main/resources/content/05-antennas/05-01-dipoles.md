...
The fix is a **1:1 current balun (choke balun)** at the feedpoint. See §05-12 for the details. In practice: every coax-fed dipole should have a choke balun at the center, period.
...
For genuine multi-band coverage with separate resonance per band, see **fan dipoles** (multiple parallel dipoles, all at the center insulator, only one resonant per band) and **trap dipoles** (§05-08).
...
- **Inverted V** — center supported, ends drooping. See §05-02.
...
- **OCFD (Off-Center Fed Dipole)** — fed about 1/3 of the way from one end. Higher feed impedance (~200 Ω, used with a 4:1 balun), works on more harmonic bands than a center-fed dipole. See §05-12 for the balun.
...
- §05-02 — Inverted V (the dipole most operators actually build)
- §05-12 — Baluns: which one and where to put it
- §05-13 — Why height changes everything
- §05-15 — Reading the dipole's radiation pattern
- §08 — Antenna calculator
- §09-04 — Feedline and SWR effects
