...
- §05-01 — Dipole feeding (where most baluns go)
- §05-04 — EFHW (49:1 unun + separate choke is the standard)
- §05-11 — Impedance transformation (the matching aspect)
- §13-05 — Faulty balun (failure modes)
- §13-06 — Feedline routing (common-mode current symptoms)
- §15 — RFI (common-mode current is a major cause)
