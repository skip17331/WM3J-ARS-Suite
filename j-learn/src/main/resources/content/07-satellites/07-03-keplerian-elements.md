...
- §07-02 — Doppler shift (depends on knowing position from elements)
- §07-04 — Tracking strategies (the orbital position output of element propagation)
- §07-07 — Pass prediction (the practical output of all this)
