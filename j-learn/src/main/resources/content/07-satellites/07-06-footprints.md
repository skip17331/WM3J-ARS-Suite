...
- §07-04 — Tracking strategies (where in the footprint to point)
- §07-07 — Pass prediction (when your station is inside the footprint)
- §11-05 — Portable budget (path loss to satellite calculation)
