...
For an inverting transponder, the convention is to **tune the uplink** to compensate. The downlink will then appear at its rest frequency. (See §07-02 for the math.)
...
- §07-02 — Doppler shift (the conceptual treatment)
