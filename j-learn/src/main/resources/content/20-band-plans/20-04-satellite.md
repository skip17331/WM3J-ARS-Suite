...
This section catalogs the satellite sub-bands and what's typical in each. For *operating* satellites — Doppler tuning, mode selection, satellite scheduling — see §07.
...
- §07 — Satellites (operating-procedure detail)
- §07-01 — FM vs. linear satellites
- §07-02 — Doppler shift correction
