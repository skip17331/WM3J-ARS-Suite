...
This section covers what to track, how to record it, and how it integrates with the maintenance schedule (§17-02).
...
- **Maintenance scheduling (§17-02)**: the quarterly firmware-review cycle.
- **Troubleshooting (§11)**: "what changed recently" lookup.
- **Resale (§16)**: documenting current-firmware status.
- **Pre-deployment readiness**: verify before contests, drills, emergencies.

## See also

- §15-00 — Schema overview
- §15-01 — Radios (where firmware most commonly lives)
- §15-07 — Purchase dates (paired with firmware update dates)
- §17-02 — Firmware updates (the maintenance side)
- §11 — Station troubleshooting (firmware as a variable)
- §16 — Estate / SK (current firmware adds resale value)
