...
- §04-00 — Chapter overview
- §04-01 — What is a repeater
- §04-02 — Offsets, tones, CTCSS, DCS (the technical fields each directory lists)
- §04-04 — Simplex calling frequencies (when no repeater is appropriate)
- §04-05 — Linked systems (DMR, Fusion, D-STAR, AllStar networks)
- §04-07 — Frequency coordination (who maintains the lists)
- §21-04 — Message forms (NTS / ARES use repeater nets)
