...
This section unpacks what SWR is, what it tells you, and how it relates to forward and reflected power. The companion sections cover the *consequences* of high SWR — extra loss (§09-03), reduced delivered power (§09-04), and feedline transformation (§09-06).
...
Note: this assumes a lossless feedline. With real feedline loss, the picture is more complicated — see §09-03.
...
The two conditions are independent. SWR tells you about the first; modeling and pattern measurement tell you about the second. See §05-13 (ground effects on efficiency) and §05-14 (modeling).
...
- §09-03 — Mismatch loss (what high SWR costs you)
- §09-04 — Power delivered vs lost
- §05-10 — Feedline effects (impedance transformation hides true SWR)
- §13 — High-SWR troubleshooting
- §05-09 — Smith charts (Γ in complex plane)
- §22 — Coax & connectors
