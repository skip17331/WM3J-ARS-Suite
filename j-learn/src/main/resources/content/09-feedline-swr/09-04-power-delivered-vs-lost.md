...
This section ties the previous three together: knowing matched-line loss (§09-01), SWR (§09-02), and mismatch loss (§09-03), how much of your transmitter's power actually reaches the antenna? And where does the lost power go?
...
Where L_total = L_matched + ΔL(SWR, L_matched) (per the table in §09-03).
...
- **Ground losses** (especially significant for verticals; see §05-13).
...
- §05-13 — Ground-plane effects (antenna efficiency)
