...
The full VF table and computation method are in §22-03. This section focuses on the SWR-and-feedline implications: how VF interacts with line-impedance transformation, where electrical length matters, and common pitfalls.
...
1. **Where you measure SWR.** Feedline transforms impedance over its length (see §09-06); a half-wave electrical line preserves the antenna's true impedance at the rig end, but other lengths transform it. Knowing electrical length tells you what transformation to expect.
...
- §09-01 — Coax loss by frequency
- §09-06 — Impedance transformation (where VF determines electrical length)
- §22-03 — Velocity factor (full reference table)
- §05-10 — Feedline effects
- §05-11 — Impedance transformation (Smith chart context)
- §08 — Antenna calculator (auto-computes lengths)
