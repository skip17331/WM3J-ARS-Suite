...
- §03-00 — Digital modes overview (audio chain)
- §03-01 — FT8 (the parent protocol)
- §03-03 — PSK31 (faster but no FEC)
- §21 — Emergency Communications (where JS8Call shines)
- §21-04 — Major emcomm nets (some have JS8Call sub-nets)
