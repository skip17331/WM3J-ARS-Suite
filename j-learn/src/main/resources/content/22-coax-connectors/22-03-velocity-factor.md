...
The J-Hub feedline calculator (in §08) does these calculations interactively — input cable type, frequency, fraction; get physical length.
...
- §22-00 — Overview
- §22-02 — Loss tables
- §05-10 — Feedline effects (electrical length transformations)
- §05-11 — Impedance transformation
- §08 — Antenna calculator (computes lengths automatically)
- §21-09 — Feedline-loss formula in the formula appendix
