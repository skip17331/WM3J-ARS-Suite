...
This section is the type-by-type reference for the common coax cables in amateur use. Each entry covers physical construction, electrical specs, typical use cases, and notes on quality variation. Loss values per band are in §22-02; velocity factors are in §22-03.
...
- §22-00 — Overview
- §22-02 — Loss tables (the per-band loss numbers for each cable here)
- §22-03 — Velocity factor (electrical-length implications)
- §22-04 — Connectors (which connectors fit which cables)
- §05-10 — Feedline effects (the *why* of coax choice)
- §20-04 — Coax replacement (when to replace)
