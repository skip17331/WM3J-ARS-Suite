...
The most universal fix. A **1:1 current balun** at the antenna feedpoint, plus optionally a second one at the rig end of the coax, breaks the common-mode current path. Discussed in §13-05.
...
- §13-05 — balun (also relates to common-mode)
- §05-12 — baluns and chokes theory
- §15-rfi — RFI in the shack (often caused by feedline radiation)
