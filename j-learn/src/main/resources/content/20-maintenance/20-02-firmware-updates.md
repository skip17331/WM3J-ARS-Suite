...
- §20-03 — Scheduled inspections (firmware-check is part of the quarterly inspection)
- §14 — Station troubleshooting (when "weird stuff started after the update")
- §18 — Shack inventory (track firmware versions per device)
