...
- §20-00 — Maintenance overview
- §20-03 — Inspections (battery terminal corrosion shows up here)
- §16 — Noise sources (battery chargers can be RFI sources — see SMPS)
- §14-06 — Power supply troubleshooting
- §18 — Shack inventory (track battery purchase dates)
