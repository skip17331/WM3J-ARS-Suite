...
- **Visible water in the dielectric.** Cut the connector off; if the white foam or solid PE is darkened, gray, or wet, water has reached it. The run is compromised. (See §13-07.)
...
The cleanest test. If you have a baseline sweep from when the cable was installed (which you should, per §20-03), compare today's sweep:
...
- §20-00 — Overview
- §20-03 — Scheduled inspections (where you'll find the symptoms)
- §13-01 — Coax issues (the troubleshooting view)
- §13-07 — Water ingress
- §22 — Coax & connectors reference
- §05-10 — Feedline effects (why loss matters)
