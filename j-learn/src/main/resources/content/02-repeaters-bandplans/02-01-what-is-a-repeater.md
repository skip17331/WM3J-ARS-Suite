...
The two are separated by a fixed amount called the **offset**. On 2 m the offset is conventionally 600 kHz; on 70 cm it's 5 MHz. Other bands use other conventions (covered in §02-02).
...
- **Simplex** = both stations transmit and receive on the same frequency. They take turns. This is what direct radio-to-radio works as. Covered in §02-04.
...
4. A **duplexer** — the box that lets the receiver and transmitter share one antenna without the transmitter desensing the receiver. Important enough to get its own section (§02-06).
...
Bigger repeater systems add **EchoLink / IRLP / AllStar** internet linking (§02-05), **voting receivers** for better coverage from low-power handhelds, and **multi-site linking** for wide-area coverage.
...
|---------|--------------|
| You key up but the repeater doesn't repeat your audio | Wrong tone / no tone (see §02-02) |
...
- §02-02 — the tone / offset settings that make your radio actually work the repeater
- §02-04 — simplex frequencies for when a repeater isn't needed
- §02-05 — repeaters that link across the internet
- §02-06 — the duplexer that lets a repeater run on one antenna
