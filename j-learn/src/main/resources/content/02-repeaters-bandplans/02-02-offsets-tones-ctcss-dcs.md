...
- §02-01 — what a repeater actually does
- §02-08 — programming non-standard offsets
- §02-07 — frequency coordination (why the same tone on the same frequency in two cities is OK)
