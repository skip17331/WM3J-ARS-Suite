...
This section catalogs the satellite sub-bands and what's typical in each. For *operating* satellites — Doppler tuning, mode selection, satellite scheduling — see §05.
...
- §18-00 — Chapter overview
- §18-02 — VHF (where the 145.8-146.0 segment lives)
- §18-03 — UHF (where 435-438 lives)
- §05 — Satellites (operating-procedure detail)
- §05-01 — FM vs. linear satellites
- §05-02 — Doppler shift correction
