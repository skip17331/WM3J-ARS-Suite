...
- §04-12 — Baluns and chokes (full discussion: when to use each, common-mode theory)
- §19-00 — Coax & connectors overview
- §10-05 — Faulty balun (troubleshooting view)
- §12 — RFI (the problem common-mode current causes)
- §17-03 — Inspections (where balun health gets checked)
