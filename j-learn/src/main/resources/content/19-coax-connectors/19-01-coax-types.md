...
This section is the type-by-type reference for the common coax cables in amateur use. Each entry covers physical construction, electrical specs, typical use cases, and notes on quality variation. Loss values per band are in §19-02; velocity factors are in §19-03.
...
- §19-00 — Overview
- §19-02 — Loss tables (the per-band loss numbers for each cable here)
- §19-03 — Velocity factor (electrical-length implications)
- §19-04 — Connectors (which connectors fit which cables)
- §04-10 — Feedline effects (the *why* of coax choice)
- §17-04 — Coax replacement (when to replace)
