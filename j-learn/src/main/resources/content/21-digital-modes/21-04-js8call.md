...
- §21-00 — Digital modes overview (audio chain)
- §21-01 — FT8 (the parent protocol)
- §21-03 — PSK31 (faster but no FEC)
- §22 — Emergency Communications (where JS8Call shines)
- §22-04 — Major emcomm nets (some have JS8Call sub-nets)
