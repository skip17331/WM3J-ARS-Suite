...
- §05-01 — FM vs linear (different Doppler treatment per type)
- §05-04 — Tracking strategies (where the Doppler correction lives)
- §05-07 — Pass prediction
- §05-08 — Doppler correction tables (lookup values per satellite)
