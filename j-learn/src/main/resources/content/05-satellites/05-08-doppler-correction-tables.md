...
This section is the **lookup reference** for Doppler shift calculations on common amateur satellites. The tables below give the maximum Doppler shift (at AOS or LOS) and the typical correction needed at intermediate elevations during a pass. The conceptual treatment is in §05-02.
...
For an inverting transponder, the convention is to **tune the uplink** to compensate. The downlink will then appear at its rest frequency. (See §05-02 for the math.)
...
- §05-02 — Doppler shift (the conceptual treatment)
