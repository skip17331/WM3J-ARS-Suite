...
This section covers how pass prediction works, what numbers it gives you, and how to choose which passes to work. The math itself is done by software (see §05-03 for the Keplerian element propagation behind it); this section is about what to do with the output.
...
A 90° pass goes straight overhead — best signal-to-noise, but creates the "azimuth flip" problem for rotators (see §05-04).
...
- §05-03 — Keplerian elements (the input to pass prediction)
- §05-04 — Tracking strategies (what to do during the pass)
- §05-06 — Footprints (the geometry of who's reachable when)
- §05-08 — Doppler correction tables (reference for active passes)
