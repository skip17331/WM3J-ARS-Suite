...
§18-14 (RF Exposure) is the longest card because that calculation pulls together more variables (power, frequency, duty cycle, gain, distance) than any other formula in the chapter — it's the canonical example of the formula-calculator pattern.
...
| 18-03 | Reactance (capacitive & inductive) | §04 antennas, §19 baluns |
| 18-04 | Impedance | §04 antennas, §08 feedline, §19 baluns |
...
| 18-08 | ERP | §06 RF safety, §09 power budget, §21 band plans |
| 18-09 | Feedline Loss | §08 feedline, §19 coax |
| 18-10 | Decibels | Almost every chapter |
| 18-11 | Q Factor | §04 antennas (mag loops), §19 baluns |
| 18-12 | Bandwidth | §02 repeaters, §04 antennas, §19 |
...
- §09 — Power Budget & ERP (puts §18-08 together with §18-09 and §18-10)
- §10 — High SWR (uses §18-04, §18-05, §18-07)
- §19 — Coax & Connectors (uses §18-09 with measured loss tables)
