...
- §13-01 — no transmit (related diagnostic flow)
- §13-04 — RF feedback (sometimes shows up as receiver weirdness)
- §15, §15 — noise sources (cause of "I hear noise but no signals")
- §12 — high SWR (the antenna problem you might have been blaming)
