...
The J-Hub feedline calculator (in §07) does these calculations interactively — input cable type, frequency, fraction; get physical length.
...
- §16-00 — Overview
- §16-02 — Loss tables
- §04-10 — Feedline effects (electrical length transformations)
- §04-11 — Impedance transformation
- §07 — Antenna calculator (computes lengths automatically)
- §15-09 — Feedline-loss formula in the formula appendix
