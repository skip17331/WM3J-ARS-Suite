...
For *additional* loss caused by SWR mismatch, see §04-10. For the use of these numbers in feedline-system design, see §04-11. This section just gives you the numbers.
...
This is why high-SWR coax problems are often hidden by long lossy cables — see §04-10 and §10-07.
...
- §16-00 — Overview
- §16-01 — Coax types
- §16-03 — Velocity factor (for electrical-length calculations)
- §04-10 — Feedline effects (the conceptual treatment)
