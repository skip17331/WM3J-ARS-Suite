...
7. **Doppler-correct your downlink** as the pass progresses. See §06-02. Your radio's display jumps as the bird climbs and descends; expect ±5 kHz on 70 cm during a pass, ±2 kHz on 2 m.
...
- §06-02 — Doppler shift (the math behind the frequency tuning)
- §06-04 — Tracking strategies (manual and automated)
