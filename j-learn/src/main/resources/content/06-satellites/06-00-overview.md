...
- **§24-04** — satellite sub-band reference (frequencies reserved for satellite uplinks/downlinks).

## See also

- §06-01 — FM vs. linear (the two satellite categories)
- §06-02 — Doppler shift (the most-counterintuitive part of satellite ops)
- §24-04 — Satellite sub-bands (frequencies)
- §02 — Repeaters & bandplans
- §05-15 — Radiation patterns (relevant for satellite antenna gain)
