...
- §06-01 — FM vs linear (different Doppler treatment per type)
- §06-04 — Tracking strategies (where the Doppler correction lives)
- §06-07 — Pass prediction
- §06-08 — Doppler correction tables (lookup values per satellite)
