...
This section covers how pass prediction works, what numbers it gives you, and how to choose which passes to work. The math itself is done by software (see §06-03 for the Keplerian element propagation behind it); this section is about what to do with the output.
...
A 90° pass goes straight overhead — best signal-to-noise, but creates the "azimuth flip" problem for rotators (see §06-04).
...
- §06-03 — Keplerian elements (the input to pass prediction)
- §06-04 — Tracking strategies (what to do during the pass)
- §06-06 — Footprints (the geometry of who's reachable when)
- §06-08 — Doppler correction tables (reference for active passes)
