...
These rules are the same as in any pile-up (see [§21-05](21-05-pile-up-etiquette.md) for the full discipline), but worth restating in the split context:
...
- [§21-05 — Pile-up Etiquette](21-05-pile-up-etiquette.md) — calling discipline once you understand split
- [§21-04 — Calling CQ](21-04-calling-cq.md) — the standard simplex QSO flow
- [§21-01 — Is the Frequency in Use?](21-01-frequency-in-use.md) — listening before transmitting
- [§17-01 — Q-Codes](../17-qcodes-prosigns/17-01-q-codes.md) — `QSX` is the relevant Q-code for split
- [§18-04 — Satellite Band Plan](../18-band-plans/18-04-satellite.md) — uplink/downlink pairs
