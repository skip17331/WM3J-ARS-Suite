...
Better practice today: use the lowest unused part of the band for tune-up. On 20 m that's typically 14.000-14.030 if it's a CW-only segment; on 40 m it's 7.000-7.020. Check your bandplan (§18) for what's CW-only or "experimental" in your region.
...
- §21-01 — "Is the frequency in use?" (the listening protocol that applies before tuning too)
- §07-15 — NanoVNA Trim Workflow (low-power on-air alternative to tuning)
- §08-02 — SWR & Reflected Power (what tuning is actually adjusting)
- §11-04 — RF Feedback (what bad tune-ups cause)
- §15-07 — SWR formula
