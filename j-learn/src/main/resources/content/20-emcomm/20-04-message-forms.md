...
For the network that carries these messages, see §20-01 (NTS) and §20-02 (ICS). For the procedures used while transmitting them, see §20-05.
...
- §20-01 — NTS (the network for radiogram delivery)
- §20-02 — ICS basics (the framework for ICS-213)
- §20-05 — Operating procedures
- §17 — Q-codes & prosigns (vocabulary)
- §19 — Digital modes (NBEMS, Fldigi)
