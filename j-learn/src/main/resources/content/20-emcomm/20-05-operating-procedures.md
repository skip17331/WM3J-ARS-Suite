...
[Message is transmitted using the radiogram protocol from §20-01]
...
- §20-01 — NTS (formal traffic-handling)
- §20-02 — ICS basics
- §20-03 — Emergency frequencies
- §20-04 — Message forms
- §02 — Repeaters & bandplans
- §17 — Q-codes & prosigns
- **J-Vault** — Shack inventory (knowing what gear you have for deployment)
