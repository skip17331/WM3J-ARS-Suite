...
A software-defined radio with a waterfall display gives you a visual fingerprint of power-line noise that can confirm the diagnosis and (sometimes) help with direction-finding. Pair this with the AM sniffer (§14-05) for the most complete tools.
...
When you file the complaint (§14-07), include screenshots:
...
- §12-08 — SDR waterfall for general RFI hunting
- §14-05 — AM radio identification (companion technique)
