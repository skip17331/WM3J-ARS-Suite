...
- **Contaminated insulators**: see §14-01; the insulator itself can corona before it fully arcs.
...
2. **Listen with a portable receiver** (§14-05).
...
Same procedure as other power-line noise (§14-07). Mention that you suspect corona specifically; this helps the utility direct the right kind of inspector (transmission engineer vs. distribution lineman).

## See also

- §14-01 — arcing insulators (different mechanism)
- §14-05 — AM radio identification
- §14-07 — utility documentation
