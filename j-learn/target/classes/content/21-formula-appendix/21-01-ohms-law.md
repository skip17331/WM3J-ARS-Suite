...
- **Confusing AC and DC values.** Ohm's Law in this form applies cleanly to DC. For AC with reactance, use complex impedance instead (§21-04).
...
- §11 — Power Budget & ERP (chains Ohm's Law into the full transmit-side calculation)
- §14 — Station Troubleshooting (voltage-drop diagnosis)
- §21-02 — Power Law (the P = V·I form, derived from this)
