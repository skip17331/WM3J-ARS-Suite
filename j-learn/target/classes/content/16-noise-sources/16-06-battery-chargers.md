...
Modern battery chargers — for power tools, e-bikes, vehicles, drones, robotic vacuums — are essentially dedicated switching power supplies optimized for cell-chemistry charging. The same RFI mechanisms apply (§16-01), but a few specifics make battery chargers their own category.
...
- §16-01 — switching power supplies (the underlying mechanism)
- §15-04 — ferrite selection
- §15-06 — step-by-step elimination
