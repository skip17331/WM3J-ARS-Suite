...
- §06-02 — Doppler shift (depends on knowing position from elements)
- §06-04 — Tracking strategies (the orbital position output of element propagation)
- §06-07 — Pass prediction (the practical output of all this)
