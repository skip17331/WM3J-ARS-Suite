...
- **`balun`** to find every section mentioning balun in the title (§04-12, §19-05).
- **`18-`** to filter to chapter 18 (Formulas) only.
- **`emcomm`** to find chapter 23.
...
| **§18 Formulas** | 📐 Formula Calculator | Opens the matching per-formula calculator in the same Antenna Workshop tab |

The banner appears for every section in the chapter, not just the overview. From §07-10 (Yagi-Uda) the banner button takes you straight to the Yagi calculator pre-filled with example values; from §18-08 (ERP) the banner opens the ERP calculator.
...
6. **§10–14** — Troubleshooting cluster (skim; come back when something breaks)
7. **§15-00** — Shack Inventory (set up your station's records)
8. **§21-00** — Band Plans (operating-frequency reference; bookmark)
...
- §15-00 — Shack Inventory (where the suite stores your station record)
