...
(Voluntary IARU plan; see §24-02 for the full HF voluntary band plan and §02 for VHF/UHF.)
...
- §02 — Repeaters & Bandplans (where the digital sub-bands fit)
- §03 — Morse code (the original "digital mode")
- §22 — Coax & Connectors (audio cables matter for digital)
- §24 — Band Plans (full sub-band layout)
- §26 — Emergency & Public Service Comms (where JS8Call and APRS live)
