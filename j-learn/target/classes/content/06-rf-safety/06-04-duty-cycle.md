...
In short: **MPE compliance covers chronic-exposure risks. Acute-injury risks need separate evaluation** (see §06-07 on RF burns).
...
- §06-02 — MPE limits (the time-averaged values being compared against)
- §06-05 — ERP (the peak-power input)
- §06-01 — FCC rules (the time-averaging is in 47 CFR 1.1310)
