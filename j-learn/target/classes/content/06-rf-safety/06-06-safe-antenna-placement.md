...
The numbers below are not legal substitutes for an actual MPE evaluation — every installation differs, and the J-Hub RF Exposure Calculator (§10) does the case-specific math. But these guidelines will keep typical amateur installs out of trouble before you start trimming dimensions.
...
- §06-02 — MPE limits
- §06-03 — Controlled vs uncontrolled
- §06-04 — Duty cycle
- §06-05 — ERP / EIRP
- §10 — RF Exposure Calculator
- §04-13 — Ground-plane effects (where the pattern goes)
- §04-15 — Radiation patterns (where the gain is high)
