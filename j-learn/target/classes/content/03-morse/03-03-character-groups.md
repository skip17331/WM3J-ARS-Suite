...
The Koch method (§03-01) introduces characters one at a time. The order matters: each new character should be sound-different from the ones already learned, and similar characters that might confuse a beginner should be spaced apart in the schedule.
...
Prosigns (signal-procedure characters) are covered in §20-02.
...
- §20-02 — prosigns (procedural characters used in operating)
