...
- §05 — Antennas (theory chapter)
- §08-00 — Antenna Workshop overview
- §08-02 — Flat Dipole (center-fed comparison)
- §08-04 — Fan Dipole (alternative multi-band approach)
- §08-15 — NanoVNA Trim Workflow
- §21-04 — Impedance (where the off-center math comes from)
