...
A trapped EFHW combines the **end-fed half-wave** topology (§08-07) with **trap circuits** (§08-13) to create a multi-band antenna in **less physical space** than a non-trapped EFHW. Each trap, resonant at one band, isolates a section of the wire above that band; below the trap's resonance the trap loads the antenna inductively.
...
The actual trap component values come from **§08-13 Trap Design**.
...
1. **Build all traps first** using §08-13 Trap Design. Verify each on a NanoVNA.
...
- §08-07 — EFHW (No Traps) — simpler, harmonic-only variant
- §08-13 — Trap Design
