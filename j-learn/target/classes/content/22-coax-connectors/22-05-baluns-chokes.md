...
- §05-12 — Baluns and chokes (full discussion: when to use each, common-mode theory)
- §22-00 — Coax & connectors overview
- §13-05 — Faulty balun (troubleshooting view)
- §15 — RFI (the problem common-mode current causes)
- §20-03 — Inspections (where balun health gets checked)
