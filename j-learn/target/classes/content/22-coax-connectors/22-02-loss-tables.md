...
For *additional* loss caused by SWR mismatch, see §05-10. For the use of these numbers in feedline-system design, see §05-11. This section just gives you the numbers.
...
This is why high-SWR coax problems are often hidden by long lossy cables — see §05-10 and §13-07.
...
- §22-00 — Overview
- §22-01 — Coax types
- §22-03 — Velocity factor (for electrical-length calculations)
- §05-10 — Feedline effects (the conceptual treatment)
