...
This chapter is the **reference appendix** for transmission lines and the connectors that go on them. It complements §05-10 (feedline effects on antenna behavior), §09 (feedline & SWR), and §20-04 (coax replacement) by being the place you look up "what is RG-213's loss at 50 MHz" or "what's the difference between PL-259 and N."

The content is organized for fast lookup, with full tables rather than long prose. If you want to *understand* feedline behavior, read §05-10. If you want to *check* a number, you're in the right chapter.
...
| 22-05 | Baluns & chokes (reference) — quick-lookup table; full discussion in §05-12 |
...
Detailed values for each common type appear in §22-01 and §22-02.
...
- §05-10 — Feedline effects (the *why* behind the numbers in this chapter)
- §05-11 — Impedance transformation
- §05-12 — Baluns and chokes (full discussion)
- §09 — Feedline & SWR
- §13-01 — Coax issues (troubleshooting view)
