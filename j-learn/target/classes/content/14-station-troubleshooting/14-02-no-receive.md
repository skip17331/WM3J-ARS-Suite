...
- §14-01 — no transmit (related diagnostic flow)
- §14-04 — RF feedback (sometimes shows up as receiver weirdness)
- §16, §17 — noise sources (cause of "I hear noise but no signals")
- §13 — high SWR (the antenna problem you might have been blaming)
