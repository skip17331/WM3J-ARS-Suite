...
- **Digital-mode "shorthand"** — JS8Call's compressed messages, FT8's predefined fields, etc., are mode-specific (see §25).

## See also

- §03 — Morse (learning to send/copy)
- §25 — Digital modes (where some of this vocabulary appears in modern usage)
- §02 — Repeaters & bandplans (calling conventions on FM)
- §26 — EmComm (procedure-heavy use of phonetics)
