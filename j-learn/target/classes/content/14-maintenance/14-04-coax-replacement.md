...
The cleanest test. If you have a baseline sweep from when the cable was installed (which you should, per §14-03), compare today's sweep:
...
- §14-00 — Overview
- §14-03 — Scheduled inspections (where you'll find the symptoms)
