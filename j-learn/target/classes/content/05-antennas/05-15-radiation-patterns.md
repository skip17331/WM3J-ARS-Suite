...
- §05-13 — Ground-plane effects (the major pattern-shaper at low heights)
- §05-14 — Modeling (tools to compute these patterns)
- §05-09 — Smith charts (matching is part of the system; pattern is the other)
