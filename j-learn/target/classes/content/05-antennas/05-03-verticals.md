...
- High-noise environment. Verticals pick up vertically-polarized man-made noise (power lines, switching supplies) more readily than horizontals do. See §17.
...
- §05-13 — Ground effects (verticals depend on ground more than any other antenna)
- §05-15 — Reading the elevation pattern of a vertical
- §05-12 — Baluns and chokes (you still want one)
- §17 — Noise sources (verticals pick up noise differently)
