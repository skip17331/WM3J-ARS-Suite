...
- **Bad bushings**: the insulator that carries the high-voltage line into the transformer can crack and arc, similar to §13-09.
...
Same direction-finding technique as for arcing insulators (§13-13, §13-14):
...
Same procedure as bad insulators (§13-15). Add to the documentation:
...
- §13-09 — arcing insulators (similar diagnostic approach)
