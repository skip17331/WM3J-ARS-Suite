...
- **Contaminated insulators**: see §13-09; the insulator itself can corona before it fully arcs.
...
2. **Listen with a portable receiver** (§13-13).
...
Same procedure as other power-line noise (§13-15). Mention that you suspect corona specifically; this helps the utility direct the right kind of inspector (transmission engineer vs. distribution lineman).

## See also

- §13-09 — arcing insulators (different mechanism)
- §13-13 — AM radio identification
- §13-15 — utility documentation
