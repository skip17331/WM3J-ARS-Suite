...
A software-defined radio with a waterfall display gives you a visual fingerprint of power-line noise that can confirm the diagnosis and (sometimes) help with direction-finding. Pair this with the AM sniffer (§13-13) for the most complete tools.
...
When you file the complaint (§13-15), include screenshots:
...
- §13-13 — AM radio identification (companion technique)
