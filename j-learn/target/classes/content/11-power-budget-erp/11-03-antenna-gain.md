...
The "antenna at 0.5 λ above good ground has gain X dBi" numbers in §05-15 already include the ground-reflection gain. Modeling software reports both free-space and over-real-ground, distinguishing the two.
...
- §05-15 — Radiation patterns (where these gain numbers come from)
- §05-13 — Ground-plane effects (how ground modifies free-space gain)
- §05-14 — Modeling concepts
- §07-05 — ERP for RF safety
