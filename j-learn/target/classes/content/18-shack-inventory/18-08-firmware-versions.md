...
This section covers what to track, how to record it, and how it integrates with the maintenance schedule (§20-02).
...
- **Maintenance scheduling (§20-02)**: the quarterly firmware-review cycle.
- **Troubleshooting (§14)**: "what changed recently" lookup.
- **Resale (§19)**: documenting current-firmware status.
- **Pre-deployment readiness**: verify before contests, drills, emergencies.

## See also

- §18-00 — Schema overview
- §18-01 — Radios (where firmware most commonly lives)
- §18-07 — Purchase dates (paired with firmware update dates)
- §20-02 — Firmware updates (the maintenance side)
- §14 — Station troubleshooting (firmware as a variable)
- §19 — Estate / SK (current firmware adds resale value)
