...
> ⚙️ **Advanced —** The Q of a resonant circuit (§18-11) determines how sharp the resonance is. Q = 2π · stored energy / energy lost per cycle = X_L / R = X_C / R at resonance. A high-Q antenna trap (Q > 50) is sharply tuned and stays "open" only over a narrow band; a low-Q trap (Q ~ 10) tunes broadly but with more loss.

## See also

- §04-08 — Traps (uses this formula for multi-band antennas)
- §10-04 — High-SWR diagnosis (off-resonance is one cause)
- §18-03 — Reactance (the X_L = X_C condition that defines resonance)
- §18-11 — Q Factor (sharpness of the resonance)
- §18-12 — Bandwidth (how Q and resonance interact)
