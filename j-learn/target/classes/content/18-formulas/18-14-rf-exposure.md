...
| Feedline loss | L | 0.5 dB … 10 dB | dB | §18-09 |
...
(Linear feedline-loss factor; see §18-09 for the conversion.)
...
(See §18-08 for the dBi/dBd conversion.)
...
L = 1 dB              (LMR-400, 100 ft, 14 MHz — see §18-09)
G = 6 dBd → 8.15 dBi
...
- §18-08 — ERP / EIRP (the formula card this builds on)
- §18-09 — Feedline Loss (where L comes from)
- §18-10 — Decibels (the dB ↔ linear conversions used throughout)
