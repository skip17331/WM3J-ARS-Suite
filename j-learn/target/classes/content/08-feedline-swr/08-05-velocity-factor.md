...
The full VF table and computation method are in §19-03. This section focuses on the SWR-and-feedline implications: how VF interacts with line-impedance transformation, where electrical length matters, and common pitfalls.
...
1. **Where you measure SWR.** Feedline transforms impedance over its length (see §08-06); a half-wave electrical line preserves the antenna's true impedance at the rig end, but other lengths transform it. Knowing electrical length tells you what transformation to expect.
...
- §19-03 — Velocity factor (full reference table)
