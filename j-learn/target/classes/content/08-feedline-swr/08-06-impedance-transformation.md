...
This section unpacks both. The general matching-network discussion is in §04-11; this section focuses on the feedline-specific behavior.
...
In between λ/4 and λ/2, the line transforms impedance into a complex value (with both real and imaginary parts). On the Smith chart (§04-09), this looks like the impedance "spiraling" around the chart center as you move along the line.
...
Recall from §08-03: a 6 dB lossy line with shorted antenna shows ~2.6:1 SWR at the rig.
...
The matching section's length depends on the cable's VF (see §08-05).
...
- §16-03 — Velocity factor reference
