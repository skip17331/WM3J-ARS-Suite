...
|-------------|----------------|
| **Cable type** | RG-58, RG-213, LMR-400, etc. (cross-references §19-01) |
...
| **Connectors at each end** | PL-259, N, BNC, etc. (cross-references §19-04) |
...
Notes: Original install. No visible jacket damage. Working as expected.
       Plan replacement at 2028 (10 years) per §17-04.
```
...
For estate disposition (§16): coax runs are typically not separately resaleable. A buyer of the station wants the radios, antennas, and accessories; the coax in place is replaced or kept by the seller. Document estimated value as low-but-not-zero (salvage of connectors/copper).
...
- §15-02 — Antennas (linked to coax runs)
- §19-01 — Coax types (full reference)
- §19-04 — Connectors
- §19-02 — Loss tables
- §17-04 — Coax replacement
- §10-01 — Coax issues troubleshooting
- §16 — Estate / SK (coax not typically separately disposed)
