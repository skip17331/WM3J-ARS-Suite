...
1. **Check the manufacturer's production date** (sometimes derivable from serial number; see §15-06).
...
- §15-06 — Serial numbers (paired with date for warranty)
- §15-08 — Firmware versions (firmware update dates)
- §17-00 — Maintenance overview (where dates feed the schedule)
- §17-01 — Battery maintenance (calendar age matters)
- §17-04 — Coax replacement (install date sets replacement schedule)
- §16 — Estate / SK (acquisition date supports resale)
