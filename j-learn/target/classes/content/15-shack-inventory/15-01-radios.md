...
Radio firmware changes; tracking the version helps you know whether bugs/features have been addressed. Re-inventory the firmware version when you update (see §15-08 and §17-02).
...
Track accessories under §15-05; cross-reference from the radio's notes field.
...
- §15-05 — Accessories (mics, batteries, chargers)
- §15-06 — Serial numbers (what they're for, how to handle missing ones)
- §15-07 — Purchase dates (warranty status, depreciation)
- §15-08 — Firmware versions (tracking pattern)
- §17-02 — Firmware updates (when to bump the version)
- §16 — Estate / SK (where the radio inventory feeds the disposition plan)
