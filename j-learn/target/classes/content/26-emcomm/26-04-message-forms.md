...
For the network that carries these messages, see §26-01 (NTS) and §26-02 (ICS). For the procedures used while transmitting them, see §26-05.
...
- §26-01 — NTS (the network for radiogram delivery)
- §26-02 — ICS basics (the framework for ICS-213)
- §26-05 — Operating procedures
- §23 — Q-codes & prosigns (vocabulary)
- §25 — Digital modes (NBEMS, Fldigi)
