...
A printable, executable checklist for systematically eliminating sources of RFI in your house. Use this when the isolation workflow (§15-05) has identified a noisy circuit but you need to pin down which device on it. Or when you're doing a baseline cleanup of your shack and want to systematically reduce the noise floor by 6+ dB.
...
- §15-05 — isolation workflow (the higher-level approach)
- §16, §17 — specific source categories
