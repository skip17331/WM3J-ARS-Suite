...
A software-defined radio with a waterfall display gives you a visual fingerprint of power-line noise that can confirm the diagnosis and (sometimes) help with direction-finding. Pair this with the AM sniffer (§17-05) for the most complete tools.
...
When you file the complaint (§17-07), include screenshots:
...
- §15-08 — SDR waterfall for general RFI hunting
- §17-05 — AM radio identification (companion technique)
