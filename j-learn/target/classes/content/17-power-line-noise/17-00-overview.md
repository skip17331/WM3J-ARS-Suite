...
Power-line noise is its own beast. Unlike household RFI (chapter 15, 16), the source is **utility infrastructure** — poles, transformers, insulators, hardware — not anything inside your house. You can't fix it with a ferrite core; the fix involves the utility company. This chapter walks the diagnosis, the documentation, and the working-with-the-utility process.
...
| Cause | Sound | Section |
|-------|-------|---------|
| Cracked / contaminated insulator | Sharp crackle, weather-related | §17-01 |
| Bad transformer (saturated, loose laminations) | 60 Hz buzz | §17-02 |
| Loose hardware (bolts, ground straps) | Intermittent crackle | §17-03 |
| Corona discharge | Whoosh / buzz, weather-related | §17-04 |
...
| § | Topic |
|---|-------|
| 17-01 | Arcing insulators (the most common cause) |
| 17-02 | Bad transformers |
| 17-03 | Loose hardware |
| 17-04 | Corona discharge |
| 17-05 | AM radio identification |
| 17-06 | SDR identification |
| 17-07 | Utility documentation (the most important practical chapter) |

Read §17-07 first if you've already identified power-line noise and want to know what to do about it. Read the rest if you're trying to characterize what specifically you're dealing with.
...
§17-07 covers the practical procedure in detail.
...
- §15 — household RFI (different beast; this overview helps distinguish)
- §17-07 — utility documentation procedure
