...
The AM radio sniffer technique from §15-07 works for power-line noise too — with some adaptations. Power-line sources are usually stronger than household sources and at a greater distance, which changes the practical procedure.
...
Save these notes. They become the basis of your utility complaint (§17-07).

## See also

- §15-07 — AM radio sniffer for household RFI (similar technique)
- §17-06 — SDR identification (alternative for harder cases)
