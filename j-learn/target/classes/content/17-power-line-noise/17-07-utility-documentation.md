...
- §17-01 — arcing insulators (most common cause)
- §17-05 — AM radio identification (where the diagnosis comes from)
- §17-06 — SDR identification
- §15 — household RFI (for problems that turn out not to be utility-related)
