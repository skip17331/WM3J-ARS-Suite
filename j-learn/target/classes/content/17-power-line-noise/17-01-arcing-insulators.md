...
Walk your neighborhood with a portable AM or shortwave radio (see §17-05 for AM, §17-06 for SDR):
...
Then file the complaint per §17-07.
...
- §17-04 — corona discharge (similar but different mechanism)
- §17-05 — AM radio identification (the practical hunt)
