...
Coax / connector / common-mode current issue. The antenna is fine; the feedline isn't. See §10-01, §10-02, §10-06.
...
- §04-antennas (chapter 05) — antenna design fundamentals
- §07-antenna-calc — calculators for antenna lengths
- §10-04 — nearby metal effects (often confused with length issues)
