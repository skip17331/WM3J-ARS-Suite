...
- **Pure RF source** that's frequency-specific (no broad spectrum). E.g., a single cleaning oscillator. Use a SDR with a waterfall (§12-08) to see exactly which frequencies are affected.
