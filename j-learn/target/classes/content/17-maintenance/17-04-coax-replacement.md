...
The cleanest test. If you have a baseline sweep from when the cable was installed (which you should, per §17-03), compare today's sweep:
...
- §17-00 — Overview
- §17-03 — Scheduled inspections (where you'll find the symptoms)
