...
- §21-01 — "Is the frequency in use?" (the call before the CQ)
- §21-03 — Identifying (rules during the QSO)
- §21-05 — Pile-up etiquette (the special case for DX and contests)
- §17-04 — Phonetic alphabet
- §17-01 — Q-codes (QRZ, QSY, etc.)
