...
- §21-01 — "Is the frequency in use?" (where ID first appears in the QSO)
- §20 — Emergency comms (where tactical callsigns coexist with FCC IDs)
- §02 — Repeaters (repeater ID is automatic but yours is not)
