...
§15-14 (RF Exposure) covers the calculations. The simple version: 100 W from a tower antenna is well below MPE limits at typical distances; 1500 W can require careful placement and warning labels.
...
§09-04 (ERP Output) and §15-08 (ERP) cover how antenna gain interacts with power.
...
Covered in §21-01. Universally applicable — every band, every mode.
