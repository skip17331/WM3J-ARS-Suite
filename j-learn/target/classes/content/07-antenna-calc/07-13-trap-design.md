...
(See §18-05.) At f_r, the inductor and capacitor's reactances cancel — the parallel combination presents a very high impedance. Above f_r the trap looks capacitive; below f_r it looks inductive (and adds physical-length-shortening loading inductance to the antenna).
