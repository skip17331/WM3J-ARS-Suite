...
In short: **MPE compliance covers chronic-exposure risks. Acute-injury risks need separate evaluation** (see §07-07 on RF burns).
...
- §07-02 — MPE limits (the time-averaged values being compared against)
- §07-05 — ERP (the peak-power input)
- §07-01 — FCC rules (the time-averaging is in 47 CFR 1.1310)
- §10 — RF Exposure Calculator (handles duty cycle automatically)
