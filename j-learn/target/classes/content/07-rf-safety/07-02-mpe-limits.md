...
- §07-01 — FCC rules (the regulatory framework)
- §07-03 — Controlled vs uncontrolled (which limit applies where)
- §07-04 — Duty cycle (the time-averaging factor)
- §07-05 — ERP (the input to power-density calculations)
- §07-06 — Safe antenna placement (using these limits in installation design)
