...
1. **Know your ERP** on each band. (See §07-05.)
...
3. **Compute or look up the MPE distance** for that ERP and that frequency. (Tables in §07-02; the ARRL has a free online evaluator. The J-Hub RF Exposure Calculator at §10 does this interactively.)
...
The "magnetic loop on your desk" case is one of the genuinely problematic amateur configurations, even at low power. See §07-06.
...
- **§07 (this chapter)** — the conceptual background for both calculators.

## See also

- §10 — RF Exposure Calculator (the practical tool)
- §11 — ERP / Power Budget
- §05-13 — Ground-plane effects (matters for near-field calculation)
- §05-15 — Patterns (gain at the relevant elevation matters for exposure direction)
