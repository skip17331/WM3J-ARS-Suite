...
- §07-01 — FCC rules
- §07-02 — MPE limits (the actual numbers per category)
- §07-04 — Duty cycle (time-averaging within the categories)
- §07-06 — Safe antenna placement (where category boundaries fall)
