...
| Q | Quality factor (§15-11) | dimensionless |
...
A receiver with a 2.5 kHz audio passband can hold about 2500 / 50 ≈ 50 simultaneous FT8 signals — which is why FT8 operates so densely. (See §19 for digital-modes bandwidth math.)
...
- §15-11 — Q Factor (relates Q to BW)
- §19 — Digital modes (where signal bandwidth is computed per protocol)
