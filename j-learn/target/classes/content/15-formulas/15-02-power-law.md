...
The relationship between voltage, current, resistance, and power. Combines Ohm's Law (§15-01) with the definition of power. Comes up every time you size a power supply, fuse, dummy load, resistor, or PA stage.
...
- §15-01 — Ohm's Law (Ohm's Law combined with P = V·I gives the full set)
- §15-08 — ERP (uses the same dB-style power math)
- §15-10 — Decibels (the log-domain way to manipulate power ratios)
