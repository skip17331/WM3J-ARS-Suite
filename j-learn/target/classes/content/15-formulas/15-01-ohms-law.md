...
- **Confusing AC and DC values.** Ohm's Law in this form applies cleanly to DC. For AC with reactance, use complex impedance instead (§15-04).
...
- §15-02 — Power Law (the P = V·I form, derived from this)
