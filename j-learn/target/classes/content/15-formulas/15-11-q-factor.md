...
- §04-05 — Magnetic loops (where Q is a defining specification)
- §04-08 — Traps (high-Q traps stay sharp; low-Q traps tune broadly)
- §15-03 — Reactance (X_L and X_C from which Q is computed)
- §15-05 — Resonant frequency (where Q applies)
- §15-12 — Bandwidth (the f_r / Q relationship)
