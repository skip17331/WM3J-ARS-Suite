...
A wavelength of RF inside coax is **shorter** than free-space wavelength by the cable's velocity factor (VF, typically 0.66–0.85; see §16-03):
...
Cut a 11.5 ft length of 75 Ω cable, insert it between the antenna and the 50 Ω feedline, and you get a near-perfect impedance match at 14.150 MHz. (See §04-09 Smith charts and §04-11 impedance transformation for the geometry of why this works.)
...
- §04 — Antennas (every antenna section uses these formulas)
- §07-01 — Dipole length calculator
- §07-03 — Quarter-wave vertical
- §16-03 — Velocity factor (where the VF correction comes from)
- §15-05 — Resonant Frequency (related — where reactance balances)
