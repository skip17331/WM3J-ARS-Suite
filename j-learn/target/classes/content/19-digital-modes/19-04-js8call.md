...
- §19-00 — Digital modes overview (audio chain)
- §19-01 — FT8 (the parent protocol)
- §19-03 — PSK31 (faster but no FEC)
- §20 — Emergency Communications (where JS8Call shines)
- §20-04 — Major emcomm nets (some have JS8Call sub-nets)
