...
This section is the type-by-type reference for the common coax cables in amateur use. Each entry covers physical construction, electrical specs, typical use cases, and notes on quality variation. Loss values per band are in §16-02; velocity factors are in §16-03.
...
- §16-00 — Overview
- §16-02 — Loss tables (the per-band loss numbers for each cable here)
- §16-03 — Velocity factor (electrical-length implications)
- §16-04 — Connectors (which connectors fit which cables)
- §04-10 — Feedline effects (the *why* of coax choice)
- §14-04 — Coax replacement (when to replace)
