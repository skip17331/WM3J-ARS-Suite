...
The fix is a **1:1 current balun (choke balun)** at the feedpoint. See §04-12 for the details. In practice: every coax-fed dipole should have a choke balun at the center, period.
...
For genuine multi-band coverage with separate resonance per band, see **fan dipoles** (multiple parallel dipoles, all at the center insulator, only one resonant per band) and **trap dipoles** (§04-08).
...
- **Inverted V** — center supported, ends drooping. See §04-02.
...
- **OCFD (Off-Center Fed Dipole)** — fed about 1/3 of the way from one end. Higher feed impedance (~200 Ω, used with a 4:1 balun), works on more harmonic bands than a center-fed dipole. See §04-12 for the balun.
...
- §04-02 — Inverted V (the dipole most operators actually build)
- §04-12 — Baluns: which one and where to put it
- §04-13 — Why height changes everything
- §04-15 — Reading the dipole's radiation pattern
- §07 — Antenna calculator
- §08-04 — Feedline and SWR effects
