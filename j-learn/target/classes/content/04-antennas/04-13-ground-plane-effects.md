...
- §04-03 — Verticals (most ground-sensitive antenna)
- §04-15 — Radiation patterns (where the height-vs-angle effects show up)
- §04-14 — Modeling concepts (handling ground in NEC-style code)
- §09 — Power budget / ERP (ground losses are real losses)
