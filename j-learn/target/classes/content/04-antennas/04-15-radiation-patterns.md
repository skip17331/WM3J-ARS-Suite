...
- §04-13 — Ground-plane effects (the major pattern-shaper at low heights)
- §04-14 — Modeling (tools to compute these patterns)
- §04-09 — Smith charts (matching is part of the system; pattern is the other)
- §09 — Power budget and ERP (ERP × pattern gain = effective field strength)
