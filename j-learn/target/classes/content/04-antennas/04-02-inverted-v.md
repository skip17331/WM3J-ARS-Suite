...
1. **Safety.** A 1500 W signal at the end of an antenna can produce several kV of RF voltage. People and pets get RF burns from grabbing the wire (see §06-07).
...
- §04-01 — Dipole (the parent form)
- §04-12 — Choke balun (you really do need one)
- §04-13 — Ground-plane effects (height matters even more for a V)
- §04-15 — Reading the radiation pattern
