...
if [ -z "$JAR" ]; then
    echo "j-hub jar missing; building..."
    # j-hub bundles j-learn classes into the shaded jar; a plain `package`
    # caches a stale classpath after j-learn changes — always clean first.
