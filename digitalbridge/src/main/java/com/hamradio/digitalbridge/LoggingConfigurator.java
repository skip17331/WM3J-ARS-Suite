 ...
 *   - Rolling file at ~/.hamlog/logs/digitalbridge.log (shares the j-log log dir)
 *   - 7-day rotation
 */
public class LoggingConfigurator {
    ...
    public static void configure(boolean debug) {
        ...
        fileAppender.setFile(logDir.resolve("digitalbridge.log").toString());
        ...
        rolling.setFileNamePattern(logDir.resolve("digitalbridge.%d{yyyy-MM-dd}.log").toString());
        ...
        Logger appLogger = ctx.getLogger("com.hamradio.digitalbridge");
