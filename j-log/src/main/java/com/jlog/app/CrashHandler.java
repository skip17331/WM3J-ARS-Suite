 ...
 * modal dialog with the stack trace and a "Copy to Clipboard" button so a
 * beta tester can paste it into a bug report.
 *
 * Install once at startup from the application's {@code init()} method.
 */
