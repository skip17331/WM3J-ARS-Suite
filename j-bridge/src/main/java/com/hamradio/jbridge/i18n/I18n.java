package com.hamradio.jbridge.i18n;
...
/**
 * Internationalisation helper for j-bridge.
 *
 * English + Spanish ship embedded at
 *   resources/com/hamradio/jbridge/i18n/messages_<lang>.properties
 * Additional packs (de / fr / it / pt) load from
 *   ~/.j-hub/lang/j-bridge/messages_<lang>.properties
 */
public class I18n {

    private static final Logger log = LoggerFactory.getLogger(I18n.class);
    private static final String BUNDLE_BASE = "com.hamradio.jbridge.i18n.messages";
    private static final File PACK_DIR =
            new File(System.getProperty("user.home"), ".j-hub/lang/j-bridge");
    ...
    public static void load(String languageCode) {
        ...
        try {
            ...
            log.info("j-bridge language bundle: {}", languageCode);
        } catch (MissingResourceException ex) {
            log.warn("j-bridge language '{}' not found, falling back to English", languageCode);
