...
/**
 * Internationalisation helper for j-map.
 *
 * English + Spanish ship embedded at
 *   resources/com/wm3j/jmap/i18n/messages_<lang>.properties
 * Additional packs (de / fr / it / pt) load from
 *   ~/.j-hub/lang/j-map/messages_<lang>.properties
 */
public class I18n {

    private static final Logger log = LoggerFactory.getLogger(I18n.class);
    private static final String BUNDLE_BASE = "com.wm3j.jmap.i18n.messages";
    private static final File PACK_DIR =
            new File(System.getProperty("user.home"), ".j-hub/lang/j-map");
    ...
    public static void load(String languageCode) {
        ...
        try {
            ...
            log.info("j-map language bundle: {}", languageCode);
        } catch (MissingResourceException ex) {
            log.warn("j-map language '{}' not found, falling back to English", languageCode);
