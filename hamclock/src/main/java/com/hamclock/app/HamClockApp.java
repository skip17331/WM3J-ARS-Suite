...
import com.hamclock.ui.main.MainWindow;
import com.hamclock.web.SetupWebServer;
...
/**
 * HamClock Clone - Main Application Entry Point
 *
 ...
 */
public class HamClockApp extends Application {

    private static final Logger log = LoggerFactory.getLogger(HamClockApp.class);
