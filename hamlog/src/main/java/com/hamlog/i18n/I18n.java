 ...
 *   resources/com/hamlog/i18n/messages_<lang>.properties
 *
 * Usage:
    ...
    public static void load(String languageCode) {
        try {
            ...
            bundle = ResourceBundle.getBundle(
                "com.hamlog.i18n.messages", currentLocale);
            ...
            bundle = ResourceBundle.getBundle(
                "com.hamlog.i18n.messages", Locale.ENGLISH);
        }
    }
